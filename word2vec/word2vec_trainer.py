...
class Word2vecTrainer(Trainer):
    ...
    def __init__(self, vocabulary_path, data_index_path, negative_data_path, mxnet_para=mxnet_parameter,
                 optimizer_para=optimizer_parameter,
        ...
        self.data_index_path = data_index_path  # ./data/word2vec/train.dec
    ...
    def train_data_loader(self):
        # build data iterator
        data_loader = Word2vecDataIter(self.vocabulary_path, self.data_index_path, self.negative_data_path, self.batch_size,
